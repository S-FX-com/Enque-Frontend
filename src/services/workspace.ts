...
import { IWorkspace, ICreateWorkspace, IUpdateWorkspace, IGetWorkspace } from "@/typescript/workspace";
...
export const workspaceService = {
  ...
  async updateWorkspaceById(workspace_id: number, dataToUpdate: Partial<IUpdateWorkspace>): Promise<ServiceResponse<IWorkspace>> {
    try {
  ...
  async checkSubdomainAvailability(subdomain: string): Promise<ServiceResponse<SubdomainAvailability>> {
    try {
