  ...
  return (
    <html lang="en" className="theme-transition">
      ...
      >
        ...
        >
          <QueryProvider> {/* Wrap children with QueryProvider */}
            {children}
            ...
            toastOptions={{
              classNames: {
                error: 'bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 dark:border-red-600 text-red-700 dark:text-red-400',
                success: 'bg-green-50 dark:bg-green-900/20 border-l-4 border-green-500 dark:border-green-600 text-green-700 dark:text-green-400',
                warning: 'bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-500 dark:border-yellow-600 text-yellow-700 dark:text-yellow-400',
