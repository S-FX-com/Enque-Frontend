                        ...
                        <div className="flex items-center justify-between py-2 border-b">
                          ...
                          <div className="flex items-center space-x-2">
                            <Switch
                              ...
                              onCheckedChange={() =>
                                handleToggleSetting(
                                  notificationSettings?.agents.enque_popup.new_response.id || 0,
                                  notificationSettings?.agents.enque_popup.new_response.is_enabled
                                )
                              }
                            />
                        ...
                        <div className="flex items-center justify-between py-2 border-b">
                          ...
                          <div className="flex items-center space-x-2">
                            <Switch
                              ...
                              onCheckedChange={() =>
                                handleToggleSetting(
                                  notificationSettings?.agents.enque_popup.ticket_assigned.id || 0,
                                  notificationSettings?.agents.enque_popup.ticket_assigned
                                    .is_enabled
                                )
                              }
                            />
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <Switch
                          ...
                          onCheckedChange={() =>
                            handleToggleSetting(
                              notificationSettings?.clients.ticket_created.id || 0,
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <Switch
                          ...
                          onCheckedChange={() =>
                            handleToggleSetting(
                              notificationSettings?.clients.ticket_resolved.id || 0,
