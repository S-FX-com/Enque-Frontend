...
export const getPriorityVariant = (priority: TicketPriority | string | undefined): "destructive" | "default" | "secondary" => {
	switch (priority) {
		case "High":
...
export const getStatusVariant = (status: TicketStatus | string | undefined): "default" | "secondary" | "outline" => {
	switch (status) {
		case "Unread":
